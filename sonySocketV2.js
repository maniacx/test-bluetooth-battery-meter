...
import {
    MessageType, booleanFromByte, isValidByte, PayloadTypeV2T1 as PTV2T1,
    PayloadTypeV2T2 as PTV2T2, ValueType, DeviceSeries, DeviceColor, FunctionTypeV2T1, BatteryType,
...
export const SonySocketV2 = GObject.registerClass({
    ...
    _getCapabilityInfo() {
        ...
        const payload = [PTV2T1.CONNECT_GET_CAPABILITY_INFO, ValueType.FIXED];
        this.addMessageQueue(MessageType.COMMAND_1, payload, 'GetCapabilityInfo');
    }

    _getDeviceInfoModel() {
        this._log.info('GET DeviceInfoModel:');

        const payload = [PTV2T1.CONNECT_GET_DEVICE_INFO, ValueType.MODEL_NAME];
        this.addMessageQueue(MessageType.COMMAND_1, payload, 'GetDeviceInfoModel');
    }
    ...
    _getDeviceInfoSeriesColor() {
        ...
        const payload = [PTV2T1.CONNECT_GET_DEVICE_INFO, ValueType.SERIES_AND_COLOR_INFO];
        this.addMessageQueue(MessageType.COMMAND_1, payload, 'GetDeviceInfoSeriesColor');
    }
