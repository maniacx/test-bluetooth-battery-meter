...
* The source file can be found in the `po` directory: `io.github.maniacx.BudsLink.pot`.
<br>
<span class="fs-2">[Download](https://github.com/maniacx/BudsLink/blob/main/po/io.github.maniacx.BudsLink.pot){: .btn .btn-purple .v-align-bottom .button1-fixed-width}</span>
...
---
### 2. Select `io.github.maniacx.BudsLink.pot` and Click `Open`
...
---
### 4. Select the `io.github.maniacx.BudsLink.pot` file and Click `Open`
